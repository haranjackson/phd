...
from models.gpr.variables.derivatives import dEdρ, dEdp, dEdA, dEdA_s, dEdJ, dTdρ, dTdp
from models.gpr.variables.eos import total_energy
from models.gpr.variables.sources import theta1inv, theta2inv, K_arr, K_dis, K_ing, f_δp
from models.gpr.variables.state import heat_flux, pressure, temperature
from models.gpr.variables.state import sigma, dsigmadρ, dsigmadA, Sigma
