...
def cpp_split_stepper(obj, mat, matBC, dt, dX, maskBC):
    ...
    GPRpy.solvers.split_stepper_para(matr, matBCr, nX, dt, array(dX),
                                     obj.half_step, obj.flux_type, obj.pars,
                                     maskBC.ravel())
...
def cpp_ader_stepper(obj, mat, matBC, dt, dX, maskBC):
    ...
    GPRpy.solvers.ader_stepper_para(matr, matBCr, nX, dt, array(dX),
                                    obj.stiff_dg, obj.flux_type, obj.pars,
                                    maskBC.ravel())
