...
PYBIND11_PLUGIN(GPRpy)
{
    ...
    pybind11::class_<Par>(m_classes, "Par")
              .def(py::init<>())
              .def_readwrite("gamma", &Par::gamma)
              .def_readwrite("pinf", &Par::pinf)
              .def_readwrite("cv", &Par::cv)
              .def_readwrite("r0", &Par::r0)
              .def_readwrite("p0", &Par::p0)
              .def_readwrite("T0", &Par::T0)
              .def_readwrite("cs2", &Par::cs2)
              .def_readwrite("alpha2", &Par::alpha2)
              .def_readwrite("mu", &Par::mu)
              .def_readwrite("Pr", &Par::Pr)
              .def_readwrite("tau1", &Par::tau1)
              .def_readwrite("kappa", &Par::kappa)
              .def_readwrite("tau2", &Par::tau2);
